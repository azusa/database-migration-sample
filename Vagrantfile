...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.network :forwarded_port, guest: 22, host: 2206
  ...
  #   vb.customize ["modifyvm", :id, "--memory", "1024"]
      vb.customize ["modifyvm", :id, "--memory", "1280", "--cpus", "1" , "--ioapic", "on"]
  end

  config.vm.hostname = "database-migration.sample.fieldnotes.jp"
